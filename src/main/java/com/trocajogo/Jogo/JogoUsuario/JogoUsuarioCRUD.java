...
@Controller
public class JogoUsuarioCRUD extends AbstractService<JogoUsuario> {
	...
	public Long adicionarJogoUsuario(Long idUsuario, JogoPlataforma jogoPlataforma, boolean interesse){
	...
	private Long persistirJogoUsuario(JogoUsuario jogoUsuario){
		return super.save(jogoUsuario).getId();
	}
