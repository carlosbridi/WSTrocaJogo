...
@Path("/ListarColecaoJogosUsuario")
public class ListarColecaoJogosUsuario {
    ...
    public ArrayList<Jogo> obterColecaoJogosUsuario(MultivaluedMap<String, String> usuarioParams) {
    	...
    	return jogoCRUD.buscarJogosUsuario(Integer.valueOf(usuarioParams.getFirst("idUsuario")));
    }
}
