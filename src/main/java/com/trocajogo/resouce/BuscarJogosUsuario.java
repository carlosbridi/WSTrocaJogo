...
import com.trocajogo.DAO.JogoDAO;
...
public class BuscarJogosUsuario {
    ...
    public ArrayList<TempJogoBusca> postUsuario(MultivaluedMap<String, String> buscaJogosParams) {
    	...
    	try{
    		...
    		e.printStackTrace();
    		return new ArrayList<TempJogoBusca>();
    	}
    }
