...
public class QUsuario extends EntityPathBase<Usuario> {
    ...
    private static final long serialVersionUID = -1301693270L;
    ...
    public com.querydsl.core.types.Predicate equalsBusinessLogic(Usuario usuario) {
        return Usuario.equalsBusinessLogic(this, usuario);
    }
