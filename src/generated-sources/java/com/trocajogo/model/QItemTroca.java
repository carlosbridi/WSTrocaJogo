...
public class QItemTroca extends EntityPathBase<ItemTroca> {
    ...
    public final NumberPath<Integer> idPlataformaJogoOferta = createNumber("idPlataformaJogoOferta", Integer.class);

    public final NumberPath<Integer> idPlataformaJogoTroca = createNumber("idPlataformaJogoTroca", Integer.class);
